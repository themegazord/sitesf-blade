        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="space-y-6 pt-8">
                <h1 class="text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
                    Para <span class="text-cyan-400">Distribuidoras e Conveniências</span>
                </h1>

                <p class="text-gray-300 leading-relaxed text-lg">
                    Com o <span class="font-semibold text-white">SAFI</span>, você terá controle total sobre seus produtos e nunca mais precisará se
