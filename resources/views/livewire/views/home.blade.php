            ...
            <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="space-y-4 md:space-y-6 animate-slideInLeft order-2 md:order-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 md:pt-4">
                        <x-button class="bg-cyan-400 text-white px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-medium hover:bg-cyan-500 transition-all duration-300 transform hover:scale-105 text-sm md:text-base" label="Fale Conosco" link="https://wa.me/5567999832455" external/>
                        <x-button class="bg-white text-gray-900 px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-medium hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 text-sm md:text-base" label="Saiba Mais" link="solucoes" />
                    </div>
                </div>
