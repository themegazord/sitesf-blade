<div>
  <main>
    <div class="container-solucoes-barres">
      <div class="container-solucoes-barres-left">
      ...
      <div class="container-solucoes-barres-right">
  ...
  <style>
    ...
    .container-solucoes-barres {
      display: grid;
      grid-template-columns: 60% 40%;
    }

    .container-solucoes-barres-left {
      display: flex;
    ...
    .container-solucoes-barres-left h3 {
      font-size: 2rem;
    ...
    .container-solucoes-barres-left h3 b {
      color: #2985b8;
    ...
    .container-solucoes-barres-left button:hover {
      border: none;
      background-color: #128bbc;
      cursor: pointer;
    }

    .container-solucoes-barres-right {
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    .container-solucoes-barres-right::after {
      content: '';
      height: 725px;
      width: 830px;
      position: absolute;
    ...
    .container-solucoes-barres-right img {
      height: 400px;
      z-index: 1;
    }
