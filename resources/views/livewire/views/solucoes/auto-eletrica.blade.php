        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="space-y-6 pt-8">
                <h1 class="text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
                    Para <span class="text-cyan-400">Auto Elétricas e Oficinas</span>
                </h1>

                <p class="text-gray-300 leading-relaxed text-lg">
                    Com <span class="font-semibold text-white">SAFI</span>, você pode criar ordens de serviço detalhadas com todos os dados do cliente,
                    veículo, serviços a serem realizados e valores cobrados. Acompanhe o status de cada ordem
                    em tempo real e evite confusões ou atrasos.
                </p>
                ...
                <p class="text-gray-300 leading-relaxed text-lg">
                    Baseie suas decisões em dados concretos e relatórios precisos, impulsionando o
            ...
            <div class="relative pt-8">
                ...
                <div class="relative z-10 mb-8">
                    <img
                        src="https://sitesf.br-se1.magaluobjects.com/AutoElecOficinaImagem.png"
                        alt="Auto Elétricas e Oficinas"
